...
const assets = [
	...
	"./iTopojs/img/earth.jpg",
	"./iTopojs/img/earth_atmos_4096.jpg",
	"./iTopojs/img/clouds.jpg",
	"./iTopojs/img/dot.png",
	"./iTopojs/img/lightray.jpg",
	"./iTopojs/img/lightray_yellow.jpg",
	"./iTopojs/img/LAND_MARK_01.jpg",

	"./iTopojs/json/world.json",
	"./iTopojs/json/ZenSecureNodes.json",
	"./iTopojs/json/ZenSuperNodes.json",

	"./iTopojs/Countries.js",
