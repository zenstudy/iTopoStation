...
function iTopoDialogLightStar( editor ) {
	...
	dlgTitleRow.add( new UIText( strings.getKey( 'iTopoToolbarLight/mineStar' ) ).setWidth( '120px' ) );
...
//	container.add( new UIBreak() );
	...
	{
		var lightStars = new UIButton( strings.getKey( 'iTopoToolbarLight/mineStar' ) );
