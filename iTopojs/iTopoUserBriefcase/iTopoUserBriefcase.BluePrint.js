...
function iTopoUserBriefcaseBluePrint( editor ) {
	this.editor = editor;
	var scope = this;
...
iTopoUserBriefcaseBluePrint.prototype = Object.create( UIElement.prototype );
iTopoUserBriefcaseBluePrint.prototype.constructor = iTopoUserBriefcaseBluePrint;

iTopoUserBriefcaseBluePrint.prototype = {
...
export { iTopoUserBriefcaseBluePrint };
