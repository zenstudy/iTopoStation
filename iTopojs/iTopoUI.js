...
//remove all tab created by zeping,2020.8.15
UITabbedPanel.prototype.removeAllTab = function ( ) {

	var __this = this;
	this.tabs.forEach(function(tab){__this.tabsDiv.dom.removeChild(tab.dom);})
	this.panels.forEach(function(panel){__this.panelsDiv.dom.removeChild(panel.dom);})
